...
// logo-mark.png, the detailed mark -- see components/ui/Logo.tsx for why
// a simplified small-size variant was tried and then reverted (2026-09-20,
// explicit call to keep one consistent icon everywhere).
