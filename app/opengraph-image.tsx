...
// exactly how this file went stale in the first place. A simplified
// small-size variant was tried and then reverted (2026-09-20, see
// components/ui/Logo.tsx) -- explicit call to keep one consistent
// detailed mark everywhere. Requires the Node.js runtime (not edge) for
// filesystem access to read the file.
