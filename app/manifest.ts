...
// to chase -- see git history on public/logo-mark.svg, now removed). A
// simplified small-size variant was tried and then reverted (2026-09-20,
// see components/ui/Logo.tsx) -- explicit call to keep one consistent
// detailed mark everywhere.
