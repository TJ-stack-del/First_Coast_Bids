...
export const ARTICLES: GuideArticle[] = [
    ...
    body: [
      ...
      { kind: "h2", text: "Words inside the solicitation" },
      {
        ...
        items: [
          ...
          { term: "Bid bond", meaning: "A guarantee, usually from a surety company, that you'll sign the contract if you win. Only some solicitations ask for one, and they say how much." },
      ...
      },
      {
        ...
        text: "Read the whole solicitation, including every addendum, before you decide to bid. Most bids that get thrown out fail on a missed requirement, a missing form or a missed deadline, not on price.",
      },
      {
        kind: "p",
    ...
    body: [
      ...
      { kind: "h2", text: "The harder side" },
      {
        ...
        items: [
          ...
          "Fixed deadlines. Most agencies won't accept a late bid, even by a minute.",
          ...
          "Wage rules on federal service work. Most federal service contracts over $2,500 are covered by the Service Contract Act, which sets minimum wages and fringe benefits for the workers on the job. You have to price with those rates in mind.",
          "Licensing. HVAC and electrical contractors need a state license in Florida. Cleaning and basic lawn care don't, but still need a local business tax receipt.",
        ],
      },
      ...
      {
        kind: "p",
        text: "If most of the good-fit list sounds like you, government work can be a steady part of your business. The next step is knowing where the bids are posted.",
      },
    ],
    sources: [
    ...
    body: [
      ...
      },
      {
        ...
        items: [
          ...
          "St. Johns County: DemandStar, while it moves to a new system.",
          ...
          "State of Florida agencies: the state's Vendor Bid System.",
        ],
      },
      {
        kind: "callout",
        title: "Why you can't always see the list",
        text: "Many of these sites only show open bids once you've created a vendor account. For vendors, the accounts on the sites we checked are free. It's worth signing up on the ones your local agencies use.",
      },
      { kind: "h2", text: "Let the bids come to you" },
      {
        kind: "p",
        text: "Checking a dozen websites by hand every week isn't realistic. Most of these systems will email you when a new bid is posted in the categories you pick. When you register, choose the categories that match your trade (for example janitorial services, lawn and grounds maintenance, HVAC maintenance or electrical work) and turn on the email alerts.",
      },
  ...
  },
  {
    ...
    body: [
      {
        kind: "p",
        text: "Before you can bid, agencies need to know who you are. That means registering as a vendor: once with the federal government if you want federal work, and on the websites your local agencies use. None of it should cost you anything.",
      },
      ...
      {
        kind: "p",
        text: "Each local agency, or the website it uses, has its own vendor registration. On the systems we checked, vendor accounts are free. Sign up on the ones your local agencies use, choose the categories that match your trade, and turn on email alerts. Each agency's purchasing page says which system it uses.",
      },
      { kind: "h2", text: "What to have ready" },
      {
        ...
        items: [
          ...
          "Your state license, if your trade needs one. In Florida, electrical contractors and air conditioning (HVAC) contractors are licensed through the Department of Business and Professional Regulation. Janitorial and basic lawn care don't need a state license.",
          "A certificate of insurance. Many solicitations ask for general liability insurance and set minimum amounts.",
          "Workers' compensation, when Florida law requires it: non-construction businesses once they have four or more employees, and construction businesses with even one.",
        ],
      },
      {
        kind: "p",
    ...
    body: [
      ...
      { kind: "h2", text: "While you prepare" },
      {
        ...
        items: [
          ...
          "Price it. Work out your real cost for the whole contract, including labor, supplies, equipment, insurance and overhead, then your profit. On federal service work, your labor cost must meet the wage determination.",
      ...
      { kind: "h2", text: "After you submit" },
      {
        ...
        items: [
          ...
          "Notice of intended award. The agency posts who it plans to award the contract to.",
      ...
      {
        kind: "p",
        text: "If you don't win, ask for the results or the bid tabulation. Seeing the winning price is one of the best ways to price your next bid well.",
      },
    ],
    sources: [
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        text: "Someone who didn't write the bid will spot a missing signature or a wrong total much faster than you will. It's one of the things we do on every bid we prepare.",
      },
    ],
    sources: [
  ...
  },
  {
    ...
    body: [
      ...
      {
        kind: "p",
        text: "It's a table. Each row is one requirement from the solicitation. The columns show where the requirement came from (the section or page), whether you meet it, and where in your bid you answer it. Some agencies ask for one; even when they don't, making one is the most reliable way to check your own bid.",
      },
